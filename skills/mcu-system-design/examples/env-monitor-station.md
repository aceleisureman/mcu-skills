...
**涉及文档**：`skill://mcu-sensors/references/temperature.md`（SHT30）、`skill://mcu-displays/references/oled.md`（SSD1306）、`skill://mcu-communication/references/wifi.md`（MQTT）、`skill://mcu-driver-core/templates/driver-template-i2c.c`、`skill://mcu-driver-core/templates/driver-template-rtos.c`
...
1. **总线互斥**：SHT30 与 OLED 共享 I2C，所有访问包锁 —— 参见 `skill://mcu-driver-core/templates/driver-template-rtos.c`
