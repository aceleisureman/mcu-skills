...
| INA219 电流电压监控示例 | INA219 示例、电流监控示例、功耗测量示例 | [`ina219-monitor/`](../skills/mcu-power/examples/ina219-monitor/) |
...
- examples（1）：[`ina219-monitor/`](../skills/mcu-power/examples/ina219-monitor/)
...
| 单文件项目手册示例输出 | 项目手册示例、manual-single 示例 | [`project-manual.md`](../skills/project-organizer/examples/project-manual.md) |
...
- examples（1）：[`project-manual.md`](../skills/project-organizer/examples/project-manual.md)
